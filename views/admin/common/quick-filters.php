<ul class="quick-filter-wrapper">
    ...
    <ul class="dropdown">
        ...
        <li><a href="<?php echo url('history-log', array('record_type' => 'Simple Page')); ?>"><?php echo __('Simple Page'); ?></a></li>
        <li><a href="<?php echo url('history-log', array('record_type' => 'Exhibit Page')); ?>"><?php echo __('Exhibit Page'); ?></a></li>
        <li><a href="<?php echo url('history-log', array('record_type' => 'Transcription')); ?>"><?php echo __('Transcription'); ?></a></li>
